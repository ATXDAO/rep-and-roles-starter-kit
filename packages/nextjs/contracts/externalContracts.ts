  ...
  11155111: {
    Hats: {
      ...
      abi: [
        ...
        { inputs: [{ internalType: "uint256", name: "hatId", type: "uint256" }], name: "AllHatsWorn", type: "error" },
        {
          inputs: [
        ...
        },
        {
          ...
          inputs: [
            ...
            { indexed: false, internalType: "address", name: "eligibility", type: "address" },
        ...
        },
        {
          ...
          inputs: [
            ...
            { indexed: false, internalType: "string", name: "newDetails", type: "string" },
          ],
        ...
        },
        {
          ...
          inputs: [
            { indexed: false, internalType: "uint256", name: "hatId", type: "uint256" },
            { indexed: false, internalType: "address", name: "newEligibility", type: "address" },
          ],
        ...
        },
        {
          ...
          inputs: [
            { indexed: false, internalType: "uint256", name: "hatId", type: "uint256" },
            { indexed: false, internalType: "string", name: "newImageURI", type: "string" },
          ],
        ...
        },
        {
          ...
          inputs: [
            { indexed: false, internalType: "uint256", name: "hatId", type: "uint256" },
            { indexed: false, internalType: "uint32", name: "newMaxSupply", type: "uint32" },
          ],
        ...
        },
        {
          ...
          inputs: [
            { indexed: false, internalType: "uint256", name: "hatId", type: "uint256" },
            { indexed: false, internalType: "address", name: "newToggle", type: "address" },
          ],
        ...
        },
        {
          ...
          inputs: [
            ...
            { indexed: false, internalType: "uint256", name: "newAdmin", type: "uint256" },
          ],
        ...
        },
        {
          inputs: [
            ...
            { internalType: "address[]", name: "_eligibilityModules", type: "address[]" },
