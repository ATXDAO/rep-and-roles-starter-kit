...
const externalContracts = {
  5: {
    CadentRepDistributor: {
      address: "0xDaa8dDd19899D4b02faed9c5bCE751378C36f122",
      abi: [
        {
          inputs: [
            { internalType: "address", name: "rep", type: "address" },
            { internalType: "uint256", name: "amountDistributedPerCadence", type: "uint256" },
            { internalType: "uint256", name: "cadenceCycle", type: "uint256" },
          ],
          stateMutability: "nonpayable",
          type: "constructor",
        },
        { inputs: [], name: "CadentRepDistributor__NOT_ENOUGH_TIME_PASSED", type: "error" },
        { inputs: [], name: "CadentRepDistributor__NOT_ENOUGH_TOkENS_TO_DISTRIBUTE", type: "error" },
        {
          anonymous: false,
        ...
        {
          inputs: [],
          name: "getAmountToDistributePerCadence",
