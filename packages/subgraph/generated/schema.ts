...
export class Token extends Entity {
  ...
  get isTradeable(): boolean {
    let value = this.get("isTradeable");
    if (!value || value.kind == ValueKind.NULL) {
      return false;
    } else {
      return value.toBoolean();
  ...
  set isTradeable(value: boolean) {
    this.set("isTradeable", Value.fromBoolean(value));
  }

  get maxMintAmount(): BigInt {
    let value = this.get("maxMintAmount");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set maxMintAmount(value: BigInt) {
    this.set("maxMintAmount", Value.fromBigInt(value));
  }
