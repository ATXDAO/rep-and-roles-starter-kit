...
contract HatsEligibilitiesChain is HatsEligibilityModule {
  ...
  //////////////////////////////////////////////////////////////*/
     ...
     */
    function CONJUCTION_CLAUSE_LENGTHS()
        public
        pure
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function getWearerStatus(
        address _wearer,
        uint256 _hatId
    ) public view virtual override returns (bool eligible, bool standing) {
        ...
        while (clauseIndex < numClauses) {
            ...
            while (moduleOffset < nextClauseOffset) {
                ...
                (eligibleInModule, standingInModule) = HatsEligibilityModule(
                    module
        ...
        */
        ...
        while (clauseIndex < numClauses) {
            ...
            while (moduleOffset < nextClauseOffset) {
                module = _getArgAddress(moduleOffset);
                (, standingInModule) = HatsEligibilityModule(module)
                    .getWearerStatus(_wearer, _hatId);
